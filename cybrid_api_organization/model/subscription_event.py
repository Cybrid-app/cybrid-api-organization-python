...
class SubscriptionEvent(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'context_data': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'context_data': 'context_data',  # noqa: E501
    ...
    def _from_openapi_data(cls, guid, event_type, object_guid, environment, organization_guid, created_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            context_data ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Context data for email template rendering.. [optional]  # noqa: E501
