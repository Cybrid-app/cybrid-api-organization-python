...
class Subscription(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'recipient': (str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, name, type, environment, state, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            url (str, none_type): The url for the subscription. Required when subscription_type is webhook.. [optional]  # noqa: E501
            signing_key (str): Subscription private signing key. Optional when subscription_type is webhook.. [optional]  # noqa: E501
            recipient (str, none_type): Recipient email address. Required when subscription_type is email.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, name, type, environment, state, *args, **kwargs):  # noqa: E501
        """Subscription - a model defined in OpenAPI
