...
class PostSubscription(ModelNormal):
    ...
    def _from_openapi_data(cls, environment, type, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            url (str, none_type): URL provided for the subscription. Required when type is webhook.. [optional]  # noqa: E501
            recipient (str, none_type): Recipient email address. Required when type is email.. [optional]  # noqa: E501
        """
