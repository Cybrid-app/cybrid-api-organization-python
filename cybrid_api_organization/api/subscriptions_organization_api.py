...
class SubscriptionsOrganizationApi(object):
    ...
    def update_subscription(
        ...
        **kwargs
        ...
        """Patch subscription  # noqa: E501

        Update a subscription.  Required scope: **subscriptions:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_subscription(subscription_guid, patch_subscription, async_req=True)
        >>> result = thread.get()
